  ...
  <v-card>
    ...
    >
      <template slot="items" slot-scope="props">
        ...
        <td class="text-xs-center">{{ props.item.categoryNames}}</td>
    ...
    <v-dialog :v-show="show" v-model="show" max-width="900" scrollable persistent>
      <v-card>
  ...
  export default {
    ...
    methods: {
      ...
      editItem(item) {
        ...
        const names = item.categoryNames.split("/");
      ...
      getDataFromApi() {
        ...
        // }, 300)
        // 发起请求
        if(this.search.saleable=="null")
        {
          this.search.saleable = null;
        }
